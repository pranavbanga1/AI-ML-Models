import pandas as pd
from sklearn.model_selection import train_test_split# Not suppose
...
# Use the split_data function to split into training and testing sets
...
# Output the first 5 rows of the training set
print("\nFirst 5 rows of the training set (features):")
print(X_train.head())

# Output the first 5 rows of the training labels
print("\nFirst 5 rows of the training set (labels):")
print(y_train.head())

# Output the first 10 rows of the dataset including Diagnosis
